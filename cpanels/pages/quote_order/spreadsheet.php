                                        ...
                                        <div class="box-body">
                                            <table id="example2" class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                                                              <?php
                                                        $query = "select * from  projects  ORDER BY `projects`.`id` DESC ";
                                                        $array = array();
                                                        ...
                                                        if (count($rows) > 0) :
                                                            foreach ($rows as $value):
                                                                ...
                                                                <td id="op">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu" role="menu">
                                                                            ...
                                                                            <li><a href="#" class="del" id="<?php echo $id; ?>" Image="<?php echo $Image;     ?>" >والحذف</a></li>
                                                                ...
                                                                <td><img src="../../../Public/projects/<?php echo  $Image ; ?>" class="img-thumbnail" width="200" alt="Cinque Terre"></td>
