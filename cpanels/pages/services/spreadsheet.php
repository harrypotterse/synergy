                                        ...
                                        <div class="box-body">
                                            <table id="example2" class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <?php
                                                        $query = "select * from  services  ORDER BY `services`.`id` DESC ";
                                                        $array = array();
                                                                ...
                                                                <td id="op">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu" role="menu">
                                                                            ...
                                                                            <li><a href="#" id="<?php echo $id; ?>" slice="<?php echo  $slice ; ?>" Image="<?php echo $Image; ?>"  class="del">والحذف</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </td>
                                                                <td><?php echo $b . $Language; ?></td>
                                                                <td><img src="<?php echo track . $Image; ?>" class="img-thumbnail" alt="Cinque Terre" width="400"></td>
