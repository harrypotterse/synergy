...
$array_var[] = $statement17 = filter_var($_POST['statement17'], FILTER_SANITIZE_STRING);
$array_var[] = $statement18 = filter_var($_POST['statement18'], FILTER_SANITIZE_STRING);
$array_var[] = $statement19 = filter_var($_POST['statement19'], FILTER_SANITIZE_STRING);
$array_var[] = $statement20 = filter_var($_POST['statement20'], FILTER_SANITIZE_STRING);
$array_var[] = $statement21 = filter_var($_POST['statement21'], FILTER_SANITIZE_STRING);
//=================================
...
if (!$a->empty_filed($statement17)):
    $msgerr .= "<div class='alert alert-danger'>من فضلك لاتترك حقل فارغ</div>";
    $true = FALSE;
endif;
if (!$a->empty_filed($statement18)):
    $msgerr .= "<div class='alert alert-danger'>من فضلك لاتترك حقل فارغ</div>";
    $true = FALSE;
endif;
if (!$a->empty_filed($statement19)):
    $msgerr .= "<div class='alert alert-danger'>من فضلك لاتترك حقل فارغ</div>";
    $true = FALSE;
endif;
if (!$a->empty_filed($statement20)):
    $msgerr .= "<div class='alert alert-danger'>من فضلك لاتترك حقل فارغ</div>";
    $true = FALSE;
endif;
if (!$a->empty_filed($statement21)):
    $msgerr .= "<div class='alert alert-danger'>من فضلك لاتترك حقل فارغ</div>";
    $true = FALSE;
endif;
if ($true == TRUE):
    try {
        $SQL = "UPDATE `page_components` SET `statement1`= ?,`statement2`= ?,`statement3`= ?,`statement4`= ?,`statement5`= ?,`statement6`= ?,`statement7`= ?,`statement8`= ?,`statement9`= ?,`statement10`= ?,`statement11`= ?,`statement12`= ?,`statement13`= ?,`statement14`= ?,`statement15`= ?,`statement16`= ?,`statement17`= ?,`statement18`= ?,`statement19`= ?,`statement20`= ?,`statement21`= ?  WHERE `page_components`.`id`= 5";
        $array = array();
