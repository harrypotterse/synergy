                                                ...
                                                <div class='col-lg-offset-2 col-lg-10 '>
                                                    <div class="input-group margin">
                                                        <select class="form-control input-lg custom-select-lg" id="Language" name="Language">
                                                            <option id="sel" value="">Choose your language</option>
                                                    ...
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Producer">
                                                    ...
                                                    <div class="input-group margin">
                                                        ...
                                                        <span class="input-group-addon btn btn-success" data-toggle="modal" data-target="#myModal1" style="background: #222d32;"> اضافة قسم فرعي</span>
                                                    </div>
                                                            ...
                                                            <fieldset class="col-md-12">
                                                                <div class="panel-body">
                                                                    <div class="form-group margin">
                                                                        ...
                                                                        <textarea class="form-control" rows="5" id="textarea"  class="textarea" name="explained" placeholder="مواعيد العمل"></textarea>
                                                                    </div>
                                                                    <div class="form-group margin">
                                                                        <button class="btn btn-info btn-flat btn-block" type="button">التفاصيل</button>
                                                                        <textarea class="form-control" rows="5" id="textarea1"  class="textarea" name="details" placeholder="مواعيد العمل"></textarea>
                                                                    </div>
                                                                    <div class="form-group margin">
                                                                        <button class="btn btn-info btn-flat btn-block" type="button">الأبعاد</button>
                                                                        <textarea class="form-control" rows="5" id="textarea2"  class="textarea" name="Dimensions" placeholder="مواعيد العمل"></textarea>
                                                                    </div>
                                                                    <div class="form-group margin">
                                                                        <button class="btn btn-info btn-flat btn-block" type="button">التعليمات</button>
                                                                        <textarea class="form-control" rows="5" id="textarea3"  class="textarea" name="instructions" placeholder="مواعيد العمل"></textarea>
                                                                    </div>
                                                                </div>
                                                            </fieldset>
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <fieldset class="col-md-12">
                                                                <div class="panel-body">
                                                                    <div class="input-group margin">
                                                                        <input type="text" class="form-control input-lg" id="form-tags-1" name="Meta_Keywords">
                                                                        <span class="input-group-btn ">
                                                                            <button class="btn btn-info btn-flat btn-lg" type="button">Meta_Keywords</button>
                                                                        </span>
                                                                    </div>
                                                                    <div class="input-group margin">
                                                                        <textarea class="form-control custom-control" rows="10" style="resize:none" name="Meta_Details"></textarea>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background: #00c0ef;">
                                                        ...
                                                        <h4 class="modal-title">اضافة خدمة رئيسية</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="ajax/services.php" id="uploadImage1" method="post" enctype="multipart/form-data">
                                                            <div class="input-group margin">
                                        ...
                                        <div id="myModal1" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="phpajax/project_category.php" id="uploadImage2" method="post" enctype="multipart/form-data">
                                                            <div class="input-group margin">
                                                            ...
                                                            <div class="input-group margin">
                                                                <select class="form-control input-lg" id="sel1" name="services">
                                                                    <?php
                                                                ...
                                                                <span class="input-group-addon btn btn-primary"> الاقسام الرئسية</span>
                                                            </div>
