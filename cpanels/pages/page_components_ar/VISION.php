...
<?php
$class = new Achieve();
$sql = "SELECT * FROM `page_components_ar` where id=2";
$pag = new Component();
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <form action="phpajax/VISION.php" id="uploadImage" method="post" enctype="multipart/form-data">
                                            <div class="content">
                                                        ...
                                                        <div class="nav-tabs-custom">
                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane active" id="hom">
                                                                    <img src="img/vis.jpg" class="img-responsive">
                                                                </div>
                                                                <div class="tab-pane " id="tab_1-1">
                                                                    <div class="input-group margin" style="display: none">
                                                                        ...
                                                                        <input type="hidden" name="file" value="<?php echo $page_components->statement4; ?>" >
                                        ...
                                        <td><img  width="150" style="float: right" src="../../../Public/VISION/<?php echo $page_components->statement4; ?>" class="img-thumbnail" alt="Cinque Terre"></td>
