...
<?php
$class = new Achieve();
$sql = "SELECT * FROM `page_components_ar` where id=6";
$pag = new Component();
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <form action="phpajax/form.php" id="uploadImage" method="post" enctype="multipart/form-data">
                                            <div class="content">
                                        ...
                                        <td><img  width="150" style="float: right" src="../../../Public/form/<?php echo $page_components->statement5; ?>" class="img-thumbnail" alt="Cinque Terre"></td>
