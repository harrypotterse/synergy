...
<?php
$class = new Achieve();
$sql = "SELECT * FROM `page_components_ar` where id=7";
$pag = new Component();
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <form action="phpajax/contact.php" id="uploadImage" method="post" enctype="multipart/form-data">
                                            <div class="content">
                                                        ...
                                                        <div class="nav-tabs-custom">
                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane active" id="hom">
                                                                    <img src="img/conact.jpg" class="img-responsive">
                                                                </div>
                                        ...
                                        <td><img  width="150" style="float: right" src="../../../Public/contact/<?php echo $page_components->statement6; ?>" class="img-thumbnail" alt="Cinque Terre"></td>
