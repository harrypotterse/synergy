...
<?php
$class = new Achieve();
$sql = "SELECT * FROM `page_components_ar` where id=1";
$pag = new Component();
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <form action="phpajax/ABOUT.php" id="uploadImage" method="post" enctype="multipart/form-data">
                                            <div class="content">
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane " id="tab_1-1">
                                                                    <div class="input-group margin" style="display: none">
                                                                        ...
                                                                        <input type="hidden" name="file" value="<?php echo $page_components->statement5; ?>" >
                                                                        <input type="hidden" name="file1" value="<?php echo $page_components->statement6; ?>" >
                                        ...
                                        <td><img  width="150" style="float: right" src="../../../Public/ABOUT/<?php echo $page_components->statement5; ?>" class="img-thumbnail" alt="Cinque Terre"></td>
                                        <td><img  width="150" style="float: right" src="../../../Public/ABOUT/<?php echo $page_components->statement6; ?>" class="img-thumbnail" alt="Cinque Terre"></td>
