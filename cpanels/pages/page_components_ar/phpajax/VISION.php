...
if ($true == TRUE):
    try {
        ...
        $array_var[] = files_modified($file_tmp, "../../../../Public/VISION/", $_POST['file'], $file_name);
        $SQL = "UPDATE `page_components_ar` SET `statement1`= ?,`statement2`= ?,`statement3`= ?,`statement4`= ? WHERE `page_components_ar`.`id`= 2;";
        $array = array();
