...
if ($true == TRUE):
    try {
        ...
        $array_var[] = files_modified($file_tmp, "../../../../Public/form/", $_POST['file'], $file_name);
        $array_var[] = $statement6 = filter_var($_POST['statement6'], FILTER_SANITIZE_STRING);
        $SQL = "UPDATE `page_components_ar` SET `statement1`= ?,`statement2`= ?,`statement3`= ?,`statement4`= ?,`statement5`= ?,`statement6`= ? WHERE `page_components_ar`.`id`= 6;";
        $array = array();
