                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane " id="tab_1-1">
                                                                    <div class="input-group margin">
                                                                        <textarea class="form-control custom-control" rows="12" style="resize:none" name="css"><?php echo $page_components->css; ?></textarea>     
                                                                        <span class="input-group-addon btn btn-primary">اكواد التصميم العامة</span>
                                                                    </div>
                                                                    <div class="input-group margin">
                                                                        <textarea class="form-control custom-control" rows="13" style="resize:none"  name="Meta"><?php echo $page_components->Meta; ?></textarea>     
                                                                        <span class="input-group-addon btn btn-primary"> الميتا تاج الخاصة </span>
                                                                    </div>
                                                                        <div class="input-group margin">
                                                                        <textarea class="form-control custom-control" rows="13" style="resize:none"  name="js"><?php echo $page_components->js; ?></textarea>     
                                                                        <span class="input-group-addon btn btn-primary">أكواد الجافا سكربت</span>
                                                                    </div>
                                                                </div><!-- /.tab-pane -->
                                                            </div><!-- /.tab-content -->
                                                        </div><!-- nav-tabs-custom -->
