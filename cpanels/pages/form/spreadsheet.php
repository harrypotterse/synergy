                                        ...
                                        <div class="box-body">
                                            <table id="example2" class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                                                            <?php
                                                        $query = "select * from  form  ORDER BY `form`.`id` DESC ";
                                                        $array = array();
                                                        ...
                                                        if (count($rows) > 0) :
                                                            foreach ($rows as $value):
                                                                ...
                                                                <td><?php echo $b . $Language; ?></td>
                                                                  <td><?php echo $explained5; ?></td>
                                                                   <td><?php echo $explained4; ?></td>
                                                                   <td><?php echo $explained3; ?></td>
                                                                <td><?php echo $explained2; ?></td>
                                                                <td><?php echo $explained1; ?></td>
