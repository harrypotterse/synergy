        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 '>
                                                    <div class="input-group margin" style="display: none">
                                                        ...
                                                        <input type="hidden" name="file" value="<?php echo $Icon; ?>" >
                                                    ...
                                                    <div class="input-group margin">
                                                        ...
                                                        <span class="input-group-addon btn btn-primary"> الأيكون</span>
                                                    </div>
                                                    ...
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Icon2">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">رابط الايكون</button>
                                                        </span>
                                                    </div>
                                                    <div class="input-group margin">
                                                        <textarea class="form-control custom-control" rows="10" style="resize:none" name="Explanation"><?php echo $Explanation; ?></textarea>
                    ...
                    <td><img src="../../../Public/icon/<?php echo  $Icon ; ?>" class="img-thumbnail" alt="Cinque Terre"></td>
